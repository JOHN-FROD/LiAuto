            ...
            <div className="container bg-white flex flex-wrap items-center justify-between py-4 overflow-hidden">
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <div className="flex flex-col items-center cursor-pointer">
                        ...
                        {/*            <li><a*/}
                        {/*                className="transition-all duration-200 nav-link hover:text-darkBlue ease block">uz</a>*/}
                        {/*            </li>*/}
                        {/*            <li><a*/}
                        {/*                className="transition-all duration-200 nav-link hover:text-darkBlue ease block">ru </a>*/}
                        {/*            </li>*/}
